"""Monadic functions for [`Result`][trcks.Result].

Provides utilities for functional composition of
synchronous [`Result`][trcks.Result]-returning functions.

Examples:
    Create and process a value of type [`Result`][trcks.Result]:
...
__all__ = [
    ...
    "map_success_to_awaitable_result_tuple",
    "map_success_to_iterable",
    "map_success_to_result",
    "map_success_to_result_iterable",
    "map_success_to_result_tuple",
    "map_success_to_tuple",
    "tap_failure",
    ...
    "tap_success_to_awaitable_result_tuple",
    "tap_success_to_iterable",
    "tap_success_to_result",
    "tap_success_to_result_iterable",
    "tap_success_to_result_tuple",
    "tap_success_to_tuple",
]
...
def map_failure_to_awaitable(
    ...
    **kwargs: _P.kwargs,
    ...
    Args:
        callable_: Asynchronous function to apply to the [`Failure`][trcks.Failure]
            values.
        *args:
    ...
    return compose(
        ...
        ar.map_failure_to_awaitable(callable_, *args, **kwargs),
    )
...
def map_failure_to_awaitable_result(
    ...
    **kwargs: _P.kwargs,
    ...
    """Create function that maps [`Failure`][trcks.Failure] values
    to [`AwaitableResult`][trcks.AwaitableResult] values.
    ...
    Returns:
        Maps [`Failure`][trcks.Failure] values
            to [`AwaitableFailure`][trcks.AwaitableFailure] and
            [`AwaitableSuccess`][trcks.AwaitableSuccess] values according to the given
            asynchronous function and leaves [`Success`][trcks.Success] values
            unchanged.
    ...
    return compose(
        ar.construct_from_result,
        ar.map_failure_to_awaitable_result(callable_, *args, **kwargs),
    )
...
def map_failure_to_awaitable_result_tuple(
    ...
    **kwargs: _P.kwargs,
    ...
    [`map_failure_to_awaitable_result_iterable`][trcks.fp.monads.result.map_failure_to_awaitable_result_iterable].
    """
...
def map_failure_to_iterable(
    ...
    **kwargs: _P.kwargs,
    ...
    """Create function that maps [`Failure`][trcks.Failure] values to homogeneous
    [`tuple`][tuple]s.
...
def map_failure_to_result_tuple(
    ...
    **kwargs: _P.kwargs,
    ...
    """Deprecated alias for
    [`map_failure_to_result_iterable`][trcks.fp.monads.result.map_failure_to_result_iterable].
    """
...
def map_failure_to_tuple(
    ...
    **kwargs: _P.kwargs,
    ...
    """Deprecated alias for
    [`map_failure_to_iterable`][trcks.fp.monads.result.map_failure_to_iterable].
    """
...
def map_success_to_awaitable(
    ...
    **kwargs: _P.kwargs,
    ...
    to [`AwaitableSuccess`][trcks.AwaitableSuccess] values.

    [`Failure`][trcks.Failure] values are left unchanged.

    Args:
        callable_: Asynchronous function to apply to the [`Success`][trcks.Success]
            values.
        *args:
            Positional arguments to be passed to `callable_`.
        **kwargs:
    ...
    Returns:
        Leaves [`Failure`][trcks.Failure] values unchanged and
            maps [`Success`][trcks.Success] values to new
            [`AwaitableSuccess`][trcks.AwaitableSuccess] values according to the given
    ...
    return compose(
        ar.construct_from_result,
        ar.map_success_to_awaitable(callable_, *args, **kwargs),
    )
...
def map_success_to_awaitable_result(
    ...
    **kwargs: _P.kwargs,
    ...
    Returns:
        Leaves [`Failure`][trcks.Failure] values unchanged and
            maps [`Success`][trcks.Success] values to
            [`AwaitableFailure`][trcks.AwaitableFailure] and
            [`AwaitableSuccess`][trcks.AwaitableSuccess] values according to the given
            asynchronous function.
...
def map_success_to_awaitable_result_tuple(
    ...
    **kwargs: _P.kwargs,
    ...
    """Deprecated alias for
    [`map_success_to_awaitable_result_iterable`][trcks.fp.monads.result.map_success_to_awaitable_result_iterable].
    """
    return map_success_to_awaitable_result_iterable(
        callable_, *args, **kwargs
    )  # pragma: no cover
...
def map_success_to_iterable(
    ...
    **kwargs: _P.kwargs,
    ...
    """Create function that maps [`Success`][trcks.Success] values to homogeneous
    [`tuple`][tuple]s.

    [`Failure`][trcks.Failure] values are left unchanged.

    Args:
        callable_: Function to apply to the [`Success`][trcks.Success] values,
            returning an [`Iterable`][collections.abc.Iterable].
        *args:
            Positional arguments to be passed to `callable_`.
        **kwargs:
    ...
    Returns:
        Leaves [`Failure`][trcks.Failure] values (wrapped as a tuple) unchanged and
            maps [`Success`][trcks.Success] values to homogeneous [`tuple`][tuple]s
    ...
    c: tuple[
        ...
        rt.construct_from_result,
        rt.map_successes_to_iterable(callable_, *args, **kwargs),
    )
    return compose(*c)
...
def map_success_to_result_tuple(
    ...
    **kwargs: _P.kwargs,
    ...
    """Deprecated alias for
    [`map_success_to_result_iterable`][trcks.fp.monads.result.map_success_to_result_iterable].
    """
    return map_success_to_result_iterable(
        callable_, *args, **kwargs
    )  # pragma: no cover
...
def map_success_to_tuple(
    ...
    **kwargs: _P.kwargs,
    ...
    """Deprecated alias for
    [`map_success_to_iterable`][trcks.fp.monads.result.map_success_to_iterable].
    """
    return map_success_to_iterable(callable_, *args, **kwargs)  # pragma: no cover
...
def tap_failure_to_awaitable(
    ...
    **kwargs: _P.kwargs,
    ...
    to [`Failure`][trcks.Failure] values.

    [`Success`][trcks.Success] values are passed on without side effects.

    Args:
        callable_: Asynchronous side effect to apply to the [`Failure`][trcks.Failure]
            value.
        *args:
            Positional arguments to be passed to `callable_`.
        **kwargs:
    ...
    return compose(
        ar.construct_from_result,
        ar.tap_failure_to_awaitable(callable_, *args, **kwargs),
    )
...
def tap_failure_to_awaitable_result(
    ...
    **kwargs: _P.kwargs,
    ...
    [`AwaitableResult`][trcks.AwaitableResult] to [`Failure`][trcks.Failure] values.
    ...
    Returns:
        Applies the given side effect to [`Failure`][trcks.Failure] values.
            ...
            *the original* [`Failure`][trcks.Failure] is returned.
    ...
    return compose(
        ar.construct_from_result,
        ar.tap_failure_to_awaitable_result(callable_, *args, **kwargs),
    )
...
def tap_failure_to_awaitable_result_iterable(
    ...
    **kwargs: _P.kwargs,
    ...
    """Create function that applies an asynchronous side effect with return type
    [`AwaitableResultIterable`][trcks.AwaitableResultIterable] to
    ...
    Returns:
        Applies the given side effect to [`Failure`][trcks.Failure] values.
            ...
            [`Success`][trcks.Success] values (wrapped as a tuple) without side effects.
...
def tap_failure_to_awaitable_result_tuple(
    ...
    **kwargs: _P.kwargs,
    ...
    """Deprecated alias for
    [`tap_failure_to_awaitable_result_iterable`][trcks.fp.monads.result.tap_failure_to_awaitable_result_iterable].
    """
    ...
    **kwargs: _P.kwargs,
    ...
    Returns:
        ...
        them
            ...
            on [`Success`][trcks.Success] values (wrapped as a tuple) without side
            effects.
...
def tap_failure_to_result_tuple(
    ...
    **kwargs: _P.kwargs,
    ...
    """Deprecated alias for
    [`tap_failure_to_result_iterable`][trcks.fp.monads.result.tap_failure_to_result_iterable].
    """
...
def tap_failure_to_tuple(
    ...
    **kwargs: _P.kwargs,
    ...
    """Deprecated alias for
    [`tap_failure_to_iterable`][trcks.fp.monads.result.tap_failure_to_iterable].
    """
...
def tap_success_to_awaitable(
    ...
    **kwargs: _P.kwargs,
    ...
    """Create function that applies an asynchronous side effect
    to [`Success`][trcks.Success] values.

    [`Failure`][trcks.Failure] values are passed on without side effects.

    Args:
        callable_: Asynchronous side effect to apply to the [`Success`][trcks.Success]
            value.
        *args:
            Positional arguments to be passed to `callable_`.
        **kwargs:
    ...
    return compose(
        ar.construct_from_result,
        ar.tap_success_to_awaitable(callable_, *args, **kwargs),
    )
...
def tap_success_to_awaitable_result(
    ...
    **kwargs: _P.kwargs,
    ...
    """Create function that applies an asynchronous side effect with return type
    [`AwaitableResult`][trcks.AwaitableResult] to [`Success`][trcks.Success] values.
    ...
    Examples:
        ...
        ...     return "success", None
        ...
        >>> a_rslt_1 = r.tap_success_to_awaitable_result(
        ...     lambda s: write_to_disk(s, "destination.txt")
        ... )(("failure", "missing text"))
        >>> asyncio.run(ar.to_coroutine_result(a_rslt_1))
        ('failure', 'missing text')
        >>> a_rslt_2 = r.tap_success_to_awaitable_result(
        ...     lambda s: write_to_disk(s, "output.txt")
        ... )(("failure", "missing text"))
        >>> asyncio.run(ar.to_coroutine_result(a_rslt_2))
        ('failure', 'missing text')
        >>> a_rslt_3 = r.tap_success_to_awaitable_result(
        ...     lambda s: write_to_disk(s, "destination.txt")
        ... )(("success", "Hello, world!"))
        >>> asyncio.run(ar.to_coroutine_result(a_rslt_3))
        ('failure', 'write error')
        >>> a_rslt_4 = r.tap_success_to_awaitable_result(
        ...     lambda s: write_to_disk(s, "output.txt")
        ... )(("success", "Hello, world!"))
        >>> asyncio.run(ar.to_coroutine_result(a_rslt_4))
    ...
    **kwargs: _P.kwargs,
    ...
    Returns:
        ...
        effects.
            ...
            [`Success`][trcks.Success] value is repeated once per element in the
            returned [`SuccessIterable`][trcks.SuccessIterable].
...
def tap_success_to_awaitable_result_tuple(
    ...
    **kwargs: _P.kwargs,
    ...
    """Deprecated alias for
    [`tap_success_to_awaitable_result_iterable`][trcks.fp.monads.result.tap_success_to_awaitable_result_iterable].
    """
    return tap_success_to_awaitable_result_iterable(
        callable_, *args, **kwargs
    )  # pragma: no cover
...
def tap_success_to_iterable(
    ...
    **kwargs: _P.kwargs,
    ...
    c: tuple[
        ...
        rt.construct_from_result,
        rt.tap_successes_to_iterable(callable_, *args, **kwargs),
    )
    return compose(*c)
...
def tap_success_to_result_iterable(
    ...
    **kwargs: _P.kwargs,
    ...
    """Create function that applies a side effect with return type
    [`ResultIterable`][trcks.ResultIterable] to [`Success`][trcks.Success] values.
...
def tap_success_to_result_tuple(
    ...
    **kwargs: _P.kwargs,
    ...
    """Deprecated alias for
    [`tap_success_to_result_iterable`][trcks.fp.monads.result.tap_success_to_result_iterable].
    """
    return tap_success_to_result_iterable(
        callable_, *args, **kwargs
    )  # pragma: no cover
...
def tap_success_to_tuple(
    ...
    **kwargs: _P.kwargs,
    ...
    """Deprecated alias for
    [`tap_success_to_iterable`][trcks.fp.monads.result.tap_success_to_iterable].
    """
    return tap_success_to_iterable(callable_, *args, **kwargs)  # pragma: no cover
