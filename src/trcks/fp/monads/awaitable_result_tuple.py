...
from trcks.fp._monads.awaitable_result_tuple import (
    ...
    construct_from_result_tuple,  # pyright: ignore[reportDeprecated]  # pyrefly: ignore[deprecated]
    construct_successes,
    ...
    map_failure_to_awaitable_result_tuple,  # pyright: ignore[reportDeprecated]  # pyrefly: ignore[deprecated]
    map_failure_to_awaitable_tuple,  # pyright: ignore[reportDeprecated]  # pyrefly: ignore[deprecated]
    ...
    map_successes_to_awaitable_result_tuple,  # pyright: ignore[reportDeprecated]  # pyrefly: ignore[deprecated]
    map_successes_to_awaitable_tuple,  # pyright: ignore[reportDeprecated]  # pyrefly: ignore[deprecated]
    ...
    tap_failure_to_awaitable_result_tuple,  # pyright: ignore[reportDeprecated]  # pyrefly: ignore[deprecated]
    tap_failure_to_awaitable_tuple,  # pyright: ignore[reportDeprecated]  # pyrefly: ignore[deprecated]
    ...
    tap_successes_to_awaitable_result_tuple,  # pyright: ignore[reportDeprecated]  # pyrefly: ignore[deprecated]
    tap_successes_to_awaitable_tuple,  # pyright: ignore[reportDeprecated]  # pyrefly: ignore[deprecated]
