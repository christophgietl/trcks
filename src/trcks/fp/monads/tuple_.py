...
def map_to_awaitable(
    ...
    **kwargs: _P.kwargs,
    ...
    Examples:
        ...
        (2, 3, 4)
    """
    return compose2(at.construct_from_iterable, at.map_to_awaitable(f, *args, **kwargs))
...
def tap_to_awaitable(
    ...
    **kwargs: _P.kwargs,
    ...
    Examples:
        ...
        (1, 2, 3)
    """
    return compose2(at.construct_from_iterable, at.tap_to_awaitable(f, *args, **kwargs))
