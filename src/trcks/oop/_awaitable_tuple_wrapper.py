...
class AwaitableTupleWrapper(BaseAwaitableWrapper[tuple[_T_co, ...]]):
    ...
    def map_to_awaitable_result(
        ...
        **kwargs: _P.kwargs,
        ...
        return AwaitableResultTupleWrapper(
            at.map_to_awaitable_result(f, *args, **kwargs)(self.core)
        )
    ...
    def map_to_result(
        ...
        **kwargs: _P.kwargs,
        ...
        """
        return AwaitableResultTupleWrapper(
            at.map_to_result(f, *args, **kwargs)(self.core)
        )
    ...
    def tap_to_awaitable_result(
        ...
        **kwargs: _P.kwargs,
        ...
        """
        return AwaitableResultTupleWrapper(
            at.tap_to_awaitable_result(f, *args, **kwargs)(self.core)
        )
    ...
    def tap_to_result(
        ...
        **kwargs: _P.kwargs,
        ...
        """
        return AwaitableResultTupleWrapper(
            at.tap_to_result(f, *args, **kwargs)(self.core)
        )
