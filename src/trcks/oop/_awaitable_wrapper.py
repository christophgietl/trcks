...
class AwaitableWrapper(BaseAwaitableWrapper[_T_co]):
    """Type-safe and immutable wrapper for [`Awaitable`][collections.abc.Awaitable]
    objects.

    The wrapped [`Awaitable`][collections.abc.Awaitable] can be accessed
    ...
    def construct(value: _T, /) -> AwaitableWrapper[_T]:
        """Construct and wrap an [`Awaitable`][collections.abc.Awaitable] object from a
        value.
        ...
        Returns:
            A new [`AwaitableWrapper`][trcks.oop.AwaitableWrapper] instance
                with the wrapped [`Awaitable`][collections.abc.Awaitable] object.
    ...
    def construct_from_awaitable(awtbl: Awaitable[_T], /) -> AwaitableWrapper[_T]:
        ...
        Args:
            awtbl: The [`Awaitable`][collections.abc.Awaitable] to be wrapped.
    ...
    def map(
        ...
        **kwargs: _P.kwargs,
        ...
        to the wrapped [`Awaitable`][collections.abc.Awaitable] object.
        ...
        Returns:
            A new [`AwaitableWrapper`][trcks.oop.AwaitableWrapper] instance with
        ...
        Examples:
            ...
            'Length: 13'
        """
        return AwaitableWrapper(a.map_(callable_, *args, **kwargs)(self.core))
    ...
    def map_to_awaitable(
        ...
        **kwargs: _P.kwargs,
        ...
        """
        return AwaitableWrapper(
            a.map_to_awaitable(callable_, *args, **kwargs)(self.core)
        )
    ...
    def map_to_awaitable_iterable(
        ...
        **kwargs: _P.kwargs,
        ...
        [`Iterable`][collections.abc.Iterable] to the wrapped
        [`Awaitable`][collections.abc.Awaitable] object.

        Args:
            callable_: The asynchronous function to be applied, returning an awaitable
        ...
        return AwaitableTupleWrapper(
            a.map_to_awaitable_iterable(callable_, *args, **kwargs)(self.core)
        )
    ...
    def map_to_awaitable_result(
        ...
        **kwargs: _P.kwargs,
        ...
        return AwaitableResultWrapper(
            a.map_to_awaitable_result(callable_, *args, **kwargs)(self.core)
        )
    ...
    def map_to_awaitable_result_iterable(
        ...
        **kwargs: _P.kwargs,
        ...
        return AwaitableResultTupleWrapper(
            a.map_to_awaitable_result_iterable(callable_, *args, **kwargs)(self.core)
        )
    ...
    def map_to_awaitable_result_tuple(
        ...
        **kwargs: _P.kwargs,
        ...
        [`map_to_awaitable_result_iterable`][trcks.oop.AwaitableWrapper.map_to_awaitable_result_iterable].
        """
    ...
    def map_to_awaitable_tuple(
        ...
        **kwargs: _P.kwargs,
        ...
        """Deprecated alias for
        [`map_to_awaitable_iterable`][trcks.oop.AwaitableWrapper.map_to_awaitable_iterable].
        """
    ...
    def map_to_iterable(
        ...
        **kwargs: _P.kwargs,
        ...
        """
        return AwaitableTupleWrapper(
            a.map_to_iterable(callable_, *args, **kwargs)(self.core)
        )
    ...
    def map_to_result(
        ...
        **kwargs: _P.kwargs,
        ...
        """
        return AwaitableResultWrapper(
            a.map_to_result(callable_, *args, **kwargs)(self.core)
        )
    ...
    def map_to_result_iterable(
        ...
        **kwargs: _P.kwargs,
        ...
        """
        return AwaitableResultTupleWrapper(
            a.map_to_result_iterable(callable_, *args, **kwargs)(self.core)
        )
    ...
    def map_to_result_tuple(
        ...
        **kwargs: _P.kwargs,
        ...
        """Deprecated alias for
        [`map_to_result_iterable`][trcks.oop.AwaitableWrapper.map_to_result_iterable].
        """
    ...
    def map_to_tuple(
        ...
        **kwargs: _P.kwargs,
        ...
        """Deprecated alias for
        [`map_to_iterable`][trcks.oop.AwaitableWrapper.map_to_iterable].
        """
    ...
    def tap(
        ...
        **kwargs: _P.kwargs,
        ...
        Returns:
            A new [`AwaitableWrapper`][trcks.oop.AwaitableWrapper] instance with
                the original [`Awaitable`][collections.abc.Awaitable] object.
        ...
        Examples:
            ...
            'Hello, world!'
        """
        return AwaitableWrapper(a.tap(callable_, *args, **kwargs)(self.core))
    ...
    def tap_to_awaitable(
        ...
        **kwargs: _P.kwargs,
        ...
        """
        return AwaitableWrapper(
            a.tap_to_awaitable(callable_, *args, **kwargs)(self.core)
        )
    ...
    def tap_to_awaitable_iterable(
        ...
        **kwargs: _P.kwargs,
        ...
        """
        return AwaitableTupleWrapper(
            a.tap_to_awaitable_iterable(callable_, *args, **kwargs)(self.core)
        )
    ...
    def tap_to_awaitable_result(
        ...
        **kwargs: _P.kwargs,
        ...
        """
        return AwaitableResultWrapper(
            a.tap_to_awaitable_result(callable_, *args, **kwargs)(self.core)
        )
    ...
    def tap_to_awaitable_result_iterable(
        ...
        **kwargs: _P.kwargs,
        ...
        """
        return AwaitableResultTupleWrapper(
            a.tap_to_awaitable_result_iterable(callable_, *args, **kwargs)(self.core)
        )
    ...
    def tap_to_awaitable_result_tuple(
        ...
        **kwargs: _P.kwargs,
        ...
        """Deprecated alias for
        [`tap_to_awaitable_result_iterable`][trcks.oop.AwaitableWrapper.tap_to_awaitable_result_iterable].
        """
    ...
    def tap_to_awaitable_tuple(
        ...
        **kwargs: _P.kwargs,
        ...
        """Deprecated alias for
        [`tap_to_awaitable_iterable`][trcks.oop.AwaitableWrapper.tap_to_awaitable_iterable].
        """
    ...
    def tap_to_iterable(
        ...
        **kwargs: _P.kwargs,
        ...
        """
        return AwaitableTupleWrapper(
            a.tap_to_iterable(callable_, *args, **kwargs)(self.core)
        )
    ...
    def tap_to_result(
        ...
        **kwargs: _P.kwargs,
        ...
        """
        return AwaitableResultWrapper(
            a.tap_to_result(callable_, *args, **kwargs)(self.core)
        )
    ...
    def tap_to_result_iterable(
        ...
        **kwargs: _P.kwargs,
        ...
        """
        return AwaitableResultTupleWrapper(
            a.tap_to_result_iterable(callable_, *args, **kwargs)(self.core)
        )
    ...
    def tap_to_result_tuple(
        ...
        **kwargs: _P.kwargs,
        ...
        """Deprecated alias for
        [`tap_to_result_iterable`][trcks.oop.AwaitableWrapper.tap_to_result_iterable].
        """
    ...
    def tap_to_tuple(
        ...
        **kwargs: _P.kwargs,
        ...
        """Deprecated alias for
        [`tap_to_iterable`][trcks.oop.AwaitableWrapper.tap_to_iterable].
        """
