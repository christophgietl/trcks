...
...         return "success", 0.0
...     return "failure", s
>>> r.map_failure_to_result(replace_not_found_by_default_value)(("failure", "not found"))
('success', 0.0)
...
...         return "success", (n, n)
...     return "failure", "not positive"
>>> rt.map_successes_to_result_iterable(duplicate_if_positive)(("success", (1, 2)))
('success', (1, 1, 2, 2))
>>> rt.map_successes_to_result_iterable(duplicate_if_positive)(("success", (1, -1, 2)))
('failure', 'not positive')
...
...         return "success", 0.0
...     return "failure", s
>>> recover_from_not_found = r.tap_failure_to_result(replace_not_found_with_default)
...
...         return "success", None
...     return "failure", "not positive"
>>> validate_positive_successes = rt.tap_successes_to_result(validate_positive)
...
```pycon
>>> awaitable_output = a.map_to_awaitable(write_to_disk)(a.construct("Hello, world!"))
...
```pycon
>>> a_rslt = ar.map_success_to_awaitable_result(get_square_root)(ar.construct_success(25.0))
>>> asyncio.run(ar.to_coroutine_result(a_rslt))
('success', 5.0)
...
...     await asyncio.sleep(0.001)
...     return n + 1
>>> a_tpl = at.map_to_awaitable(slowly_add_one)(at.construct_from_iterable((1, 2, 3)))
>>> asyncio.run(at.to_coroutine_tuple(a_tpl))
(2, 3, 4)
...
...         return "success", (n, n)
...     return "failure", "not positive"
>>> a_r_tpl = art.map_successes_to_awaitable_result_iterable(duplicate_if_positive)(
...
...         return "success", None
...     return "failure", "not positive"
>>> a_r_tpl = art.tap_successes_to_awaitable_result(validate_positive_slowly)(
